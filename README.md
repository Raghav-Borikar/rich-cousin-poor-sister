...
For evaluation, set the mode to evaluate and provide the path to the checkpoint. If no checkpoint path is given, the script will automatically use the latest checkpoint.
